...
%global pkg_name rcl_logging_implementation
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rcl-logging-implementation
Version:        3.4.1
Release:        3%{?dist}
...
%description
Provides the ability to load logging implementations at runtime. This package
acts as an abstraction layer between rcl and the actual logging implementation
(e.g., spdlog, noop, or custom implementations).
...
%changelog
* Wed Apr 29 2026 Tomoya Fujita <tomoya.fujita825@gmail.com> - 3.4.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Tomoya Fujita <tomoya.fujita825@gmail.com> - 3.4.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Tomoya Fujita <tomoya.fujita825@gmail.com> - 3.4.1-1
- Autogenerated by Bloom
